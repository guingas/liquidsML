...
from src.data_generation.synthetic_sensors import gerar_dataset_completo, MAPA_POTABILIDADE
...
def main():
    ...
    print("║                                                          ║")
    print("║   ETAPA 1: Classificar TIPO (água / cerveja)             ║")
    print("║   ETAPA 2: Propriedades por tipo                         ║")
    print("║     • Água   → Potabilidade + Variante                   ║")
    print("║     • Cerveja → Estilo / Marca                           ║")
    print("║                                                          ║")
    print("╚" + "═" * 58 + "╝")
